...
- Video search and summary: Refer to [system requirements](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2025.2.0/sample-applications/video-search-and-summarization/docs/user-guide/system-requirements.md) page of the sample application.
